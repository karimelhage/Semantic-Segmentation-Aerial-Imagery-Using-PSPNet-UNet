...
def augment_images(image_path, mask_path,save_path):
  ...
  for index in range(len(img_aug_list)):
      ...
      if brighten_darken_decision < 0.25:
          ...
          cv2.imwrite( save_path+'images/img_'+index_img+'_darken.tif',img_t)
          cv2.imwrite(save_path+'masks/msk_'+index_msk+'_darken.png',msk_t)
          ...
          img_t = np.array(img_t)
          msk_t = np.array(msk_t)
          cv2.imwrite(save_path+'images/img_'+index_img+'_brighten.tif',img_t)
          cv2.imwrite( save_path+'masks//msk_'+index_msk+'_brighten.png',msk_t)
      ...
      if np.random.rand() < 0.3:
          ...
          img_t = np.array(img_t)
          msk_t = np.array(msk_t)
          cv2.imwrite( save_path+'images/img_'+index_img+'_hflip.tif',img_t)
          cv2.imwrite( save_path+'masks/msk_'+index_msk+'_hflip.png',msk_t)
      ...
      if np.random.rand() < 0.3:
          ...
          img_t = np.array(img_t)
          msk_t = np.array(msk_t)
          cv2.imwrite(save_path+'images/img_'+index_img+'_vflip.tif',img_t)
          cv2.imwrite( save_path+'masks/msk_'+index_msk+'_vflip.png',msk_t)
      ...
      if np.random.rand() < 0.3:
          ...
          img_t = np.array(img_t)
          msk_t = np.array(msk_t)
          cv2.imwrite( save_path+'images/img_'+index_img+'_rot.tif',img_t)
          cv2.imwrite( save_path+'masks/msk_'+index_msk+'_rot.png',msk_t)
...
class patch_dataset(Dataset):
    ...
    def __init__(self, images_path:list, masks_path:list, patch_size_x:int,patch_size_y:int):
        self.images_paths = images_path #The paths of all the images 
